            ...
            <div className="about-intro">
                <div className="about-intro__container">
                    ...
                    <div className="about-intro__description">
                        <p data-aos='fade-right' >I am <span>LAKSHMI SUJATHA Here....</span></p>
                        ...
                        <p data-aos='fade-right' data-aos-delay='400'>Passionate front-end Developer AND iam developing highly adaptive and responsive websites using React </p>
